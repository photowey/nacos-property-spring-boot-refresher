 ...
 */
package io.github.photowey.nacos.property.refresher.scope;

import io.github.photowey.nacos.property.refresher.core.constant.RefresherConstants;
import io.github.photowey.nacos.property.refresher.shared.org.springframework.cloud.context.scope.GenericScope;
import io.github.photowey.nacos.property.refresher.shared.org.springframework.cloud.context.scope.refresh.RefreshScopeRefreshedEvent;
...
public class NacosRefreshScope extends GenericScope
    ...
    public static final String NACOS_DYNAMIC_REFRESH_SCOPE = RefresherConstants.NACOS_DYNAMIC_REFRESH_SCOPE;
    ...
    public NacosRefreshScope() {
        super.setName(NACOS_DYNAMIC_REFRESH_SCOPE);
    }
