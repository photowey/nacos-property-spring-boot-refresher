 ...
 */
package io.github.photowey.nacos.property.refresher.binder;

import io.github.photowey.nacos.property.refresher.core.thrower.AssertionErrorThrower;
...
public final class PropertyBinders {
    ...
    private PropertyBinders() {
        AssertionErrorThrower.throwz(PropertyBinders.class);
    }
